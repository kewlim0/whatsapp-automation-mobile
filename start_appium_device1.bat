@echo off
title Appium Server - Device 1 (Port 4723)
color 0B
echo ========================================================
echo      APPIUM SERVER - DEVICE 1 (PORT 4723)
echo ========================================================
echo.
...
REM Start Appium on port 4723
echo Starting Appium Server...
echo Port: 4723
echo URL: http://127.0.0.1:4723
echo.
echo ⚠️  Keep this window open!
echo ⚠️  For Device 1 automation
echo.
echo ========================================================

appium server --port 4723 --session-override --log-level info
pause
